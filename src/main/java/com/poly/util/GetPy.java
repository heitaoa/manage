...
public class GetPy {
	...
	private static final String GB_2312 =   
	     ...
	     * ��ȡGBK�ֵ�ƴ��������ĸ 
	     * �������ݽϴ�,������GBK�����GBK�淶�ֳ�3���� 
	     * GBK/2Ϊ��GB2312���ݵĹ��꺺�ֲ��֣�GBK/3��GBK/4Ϊ��չ���ֲ��� 
	     * ÿһ���ֶ����Լ��ĵ�ַ���㹫ʽ 
	     * ��������acsii�򷵻�ͬ����acsii 
	     * �������������ַ��򷵻�ƴ��������ĸ 
	     * �������������ַ����Ǹ��ַ���֪����η������򷵻ؿ��ַ� 
	    ...
	    public static String getGBKpy(String hzString) throws UnsupportedEncodingException {  
	        /* 
	         * Ч��:������ַ���(�ַ�����132055��byte,��70577��char)1000�Σ�����ʱ��44.474S. 
	         */  
	        ...
	        String returnStr = "";
	        //��  ������  Chang	  Zhang
	        if(hzString.length()>0){
		        if("��".equals(hzString.substring(0,1)))
		        	returnStr = "c";
		        else
		        	returnStr = pyBuffer.toString().trim().toLowerCase(); 
	        }
