...
public class  DboCarAutohomepropDao194  extends BaseDao {
	...
	public static void fill(ResultSet rs, DboCarAutohomeprop dbocarautohomeprop) throws SQLException {
		...
		dbocarautohomeprop.setP1(rs.getString("p1"));//�������
		dbocarautohomeprop.setP2(rs.getString("p2"));//����ָ����(Ԫ)
		dbocarautohomeprop.setP3(rs.getString("p3"));//Ʒ��
		dbocarautohomeprop.setP4(rs.getString("p4"));//����
		dbocarautohomeprop.setP5(rs.getString("p5"));//������
		dbocarautohomeprop.setP6(rs.getString("p6"));//������
		dbocarautohomeprop.setP7(rs.getString("p7"));//���������(mm)
		dbocarautohomeprop.setP8(rs.getString("p8"));//����ṹ
		dbocarautohomeprop.setP9(rs.getString("p9"));//��߳���(km/h)
		dbocarautohomeprop.setP10(rs.getString("p10"));//�ٷ�0-100km/h����(s)
		dbocarautohomeprop.setP11(rs.getString("p11"));//�ٷ�100-0�ƶ�(m)
		dbocarautohomeprop.setP12(rs.getString("p12"));//�ٷ��ۺ�·���ͺ�(l)
		dbocarautohomeprop.setP13(rs.getString("p13"));//ʵ��0-100km/h����(s)
		dbocarautohomeprop.setP14(rs.getString("p14"));//ʵ��100-0km/h�ƶ�(m)
		dbocarautohomeprop.setP15(rs.getString("p15"));//ʵ���ͺ�(l)
		dbocarautohomeprop.setP16(rs.getString("p16"));//���ʱ�
		dbocarautohomeprop.setP17(rs.getString("p17"));//����(mm)
		dbocarautohomeprop.setP18(rs.getString("p18"));//���(mm)
		dbocarautohomeprop.setP19(rs.getString("p19"));//�߶�(mm)
		dbocarautohomeprop.setP20(rs.getString("p20"));//���(mm)
		dbocarautohomeprop.setP21(rs.getString("p21"));//ǰ�־�(mm)
		dbocarautohomeprop.setP22(rs.getString("p22"));//���־�(mm)
		dbocarautohomeprop.setP23(rs.getString("p23"));//��С��ؼ�϶(mm)
		dbocarautohomeprop.setP24(rs.getString("p24"));//������(kg)
		dbocarautohomeprop.setP25(rs.getString("p25"));//����ṹ
		dbocarautohomeprop.setP26(rs.getString("p26"));//������(��)
		dbocarautohomeprop.setP27(rs.getString("p27"));//��λ��(��)
		dbocarautohomeprop.setP28(rs.getString("p28"));//�����ݻ�(l)
		dbocarautohomeprop.setP29(rs.getString("p29"));//�������ݻ�(l)
		dbocarautohomeprop.setP30(rs.getString("p30"));//����(ml)
		dbocarautohomeprop.setP31(rs.getString("p31"));//��������
		dbocarautohomeprop.setP32(rs.getString("p32"));//������ʽ
		dbocarautohomeprop.setP33(rs.getString("p33"));//���������ʽ
		dbocarautohomeprop.setP34(rs.getString("p34"));//�����(��)
		dbocarautohomeprop.setP35(rs.getString("p35"));//ÿ��������(��)
		dbocarautohomeprop.setP36(rs.getString("p36"));//ѹ����
		dbocarautohomeprop.setP37(rs.getString("p37"));//�����
		dbocarautohomeprop.setP38(rs.getString("p38"));//�׾�
		dbocarautohomeprop.setP39(rs.getString("p39"));//�г�
		dbocarautohomeprop.setP40(rs.getString("p40"));//�������(ps)
		dbocarautohomeprop.setP41(rs.getString("p41"));//�����(kw)
		dbocarautohomeprop.setP42(rs.getString("p42"));//�����ת��(rpm)
		dbocarautohomeprop.setP43(rs.getString("p43"));//���Ť��(n��m)
		dbocarautohomeprop.setP44(rs.getString("p44"));//���Ť��ת��(rpm)
		dbocarautohomeprop.setP45(rs.getString("p45"));//���������м���
		dbocarautohomeprop.setP46(rs.getString("p46"));//ȼ����ʽ
		dbocarautohomeprop.setP47(rs.getString("p47"));//ȼ�ͱ��
		dbocarautohomeprop.setP48(rs.getString("p48"));//���ͷ�ʽ
		dbocarautohomeprop.setP49(rs.getString("p49"));//�׸ǲ���
		dbocarautohomeprop.setP50(rs.getString("p50"));//�������
		dbocarautohomeprop.setP51(rs.getString("p51"));//������׼
		dbocarautohomeprop.setP52(rs.getString("p52"));//���
		dbocarautohomeprop.setP53(rs.getString("p53"));//��λ����
		dbocarautohomeprop.setP54(rs.getString("p54"));//����������
		dbocarautohomeprop.setP55(rs.getString("p55"));//��ʽ
		dbocarautohomeprop.setP56(rs.getString("p56"));//ǰ�������
		dbocarautohomeprop.setP57(rs.getString("p57"));//���������
		dbocarautohomeprop.setP58(rs.getString("p58"));//��������
		dbocarautohomeprop.setP59(rs.getString("p59"));//���̽ṹ
		dbocarautohomeprop.setP60(rs.getString("p60"));//ǰ�ƶ�������
		dbocarautohomeprop.setP61(rs.getString("p61"));//���ƶ�������
		dbocarautohomeprop.setP62(rs.getString("p62"));//פ���ƶ�����
		dbocarautohomeprop.setP63(rs.getString("p63"));//ǰ��̥���
		dbocarautohomeprop.setP64(rs.getString("p64"));//����̥���
		dbocarautohomeprop.setP65(rs.getString("p65"));//��̥���
		dbocarautohomeprop.setP66(rs.getString("p66"));//��ʻ��ȫ����
		dbocarautohomeprop.setP67(rs.getString("p67"));//����ʻ��ȫ����
		dbocarautohomeprop.setP68(rs.getString("p68"));//ǰ�Ų�����
		dbocarautohomeprop.setP69(rs.getString("p69"));//���Ų�����
		dbocarautohomeprop.setP70(rs.getString("p70"));//ǰ��ͷ������(����)
		dbocarautohomeprop.setP71(rs.getString("p71"));//����ͷ������(����)
		dbocarautohomeprop.setP72(rs.getString("p72"));//ϥ������
		dbocarautohomeprop.setP73(rs.getString("p73"));//��ȫ��δϵ��ʾ
		dbocarautohomeprop.setP74(rs.getString("p74"));//��������ӷ���
		dbocarautohomeprop.setP75(rs.getString("p75"));//�����п���
		dbocarautohomeprop.setP76(rs.getString("p76"));//ң��Կ��
		dbocarautohomeprop.setP77(rs.getString("p77"));//��Կ������ϵͳ
		dbocarautohomeprop.setP78(rs.getString("p78"));//abs������
		dbocarautohomeprop.setP79(rs.getString("p79"));//�ƶ�������(ebd/cbc��)
		dbocarautohomeprop.setP80(rs.getString("p80"));//ɲ������(eba/bas/ba��)
		dbocarautohomeprop.setP81(rs.getString("p81"));//ǣ��������(asr/tcs/trc��)
		dbocarautohomeprop.setP82(rs.getString("p82"));//�����ȶ�����(esc/esp/dsc��)
		dbocarautohomeprop.setP83(rs.getString("p83"));//�Զ�פ��/���¸���
		dbocarautohomeprop.setP84(rs.getString("p84"));//���»���
		dbocarautohomeprop.setP85(rs.getString("p85"));//�ɱ����
		dbocarautohomeprop.setP86(rs.getString("p86"));//�������
		dbocarautohomeprop.setP87(rs.getString("p87"));//̥ѹ���װ��
		dbocarautohomeprop.setP88(rs.getString("p88"));//��̥ѹ������ʻ
		dbocarautohomeprop.setP89(rs.getString("p89"));//�ɱ�ת���
		dbocarautohomeprop.setP90(rs.getString("p90"));//�綯�촰
		dbocarautohomeprop.setP91(rs.getString("p91"));//ȫ���촰
		dbocarautohomeprop.setP92(rs.getString("p92"));//ͬɫ���Ӿ�
		dbocarautohomeprop.setP93(rs.getString("p93"));//ͬɫ������
		dbocarautohomeprop.setP94(rs.getString("p94"));//�˶�����׼�
		dbocarautohomeprop.setP95(rs.getString("p95"));//���Ͻ����
		dbocarautohomeprop.setP96(rs.getString("p96"));//��Ƥ������
		dbocarautohomeprop.setP97(rs.getString("p97"));//���������µ���
		dbocarautohomeprop.setP98(rs.getString("p98"));//������ǰ�����
		dbocarautohomeprop.setP99(rs.getString("p99"));//�๦�ܷ�����
		dbocarautohomeprop.setP100(rs.getString("p100"));//�����̻���
		dbocarautohomeprop.setP101(rs.getString("p101"));//����Ѳ��
		dbocarautohomeprop.setP102(rs.getString("p102"));//��������
		dbocarautohomeprop.setP103(rs.getString("p103"));//������ƵӰ��
		dbocarautohomeprop.setP104(rs.getString("p104"));//�г�������ʾ��
		dbocarautohomeprop.setP105(rs.getString("p105"));//huḑͷ������ʾ
		dbocarautohomeprop.setP106(rs.getString("p106"));//�����Ϣ̤��
		dbocarautohomeprop.setP107(rs.getString("p107"));//��Ƥ/��Ƥ����
		dbocarautohomeprop.setP108(rs.getString("p108"));//�˶��������
		dbocarautohomeprop.setP109(rs.getString("p109"));//���θߵ͵���
		dbocarautohomeprop.setP110(rs.getString("p110"));//��֧�ŵ���
		dbocarautohomeprop.setP111(rs.getString("p111"));//ǰ�����ε綯����
		dbocarautohomeprop.setP112(rs.getString("p112"));//���������ֶ�����
		dbocarautohomeprop.setP113(rs.getString("p113"));//�������ε綯����
		dbocarautohomeprop.setP114(rs.getString("p114"));//�綯���μ���
		dbocarautohomeprop.setP115(rs.getString("p115"));//ǰ�����μ���
		dbocarautohomeprop.setP116(rs.getString("p116"));//�������μ���
		dbocarautohomeprop.setP117(rs.getString("p117"));//����ͨ��
		dbocarautohomeprop.setP118(rs.getString("p118"));//���ΰ�Ħ
		dbocarautohomeprop.setP119(rs.getString("p119"));//������������ŵ�
		dbocarautohomeprop.setP120(rs.getString("p120"));//�������α���ŵ�
		dbocarautohomeprop.setP121(rs.getString("p121"));//����������
		dbocarautohomeprop.setP122(rs.getString("p122"));//ǰ���������
		dbocarautohomeprop.setP123(rs.getString("p123"));//�����������
		dbocarautohomeprop.setP124(rs.getString("p124"));//ǰ�ű���
		dbocarautohomeprop.setP125(rs.getString("p125"));//���ű���
		dbocarautohomeprop.setP126(rs.getString("p126"));//�綯����
		dbocarautohomeprop.setP127(rs.getString("p127"));//gps����ϵͳ
		dbocarautohomeprop.setP128(rs.getString("p128"));//�п�̨��ɫ����
		dbocarautohomeprop.setP129(rs.getString("p129"));//�˻�ϵͳ
		dbocarautohomeprop.setP130(rs.getString("p130"));//����Ӳ��
		dbocarautohomeprop.setP131(rs.getString("p131"));//����ϵͳ
		dbocarautohomeprop.setP132(rs.getString("p132"));//���ص���
		dbocarautohomeprop.setP133(rs.getString("p133"));//���ص绰
		dbocarautohomeprop.setP134(rs.getString("p134"));//����Һ����
		dbocarautohomeprop.setP135(rs.getString("p135"));//�����Դ�ӿ�(aux/usb/ipod��)
		dbocarautohomeprop.setP136(rs.getString("p136"));//cd֧��mp3/wma
		dbocarautohomeprop.setP137(rs.getString("p137"));//����cd
		dbocarautohomeprop.setP138(rs.getString("p138"));//���cdϵͳ
		dbocarautohomeprop.setP139(rs.getString("p139"));//����dvd
		dbocarautohomeprop.setP140(rs.getString("p140"));//���dvdϵͳ
		dbocarautohomeprop.setP141(rs.getString("p141"));//2-3����������ϵͳ
		dbocarautohomeprop.setP142(rs.getString("p142"));//4-5����������ϵͳ
		dbocarautohomeprop.setP143(rs.getString("p143"));//6-7����������ϵͳ
		dbocarautohomeprop.setP144(rs.getString("p144"));//��8����������ϵͳ
		dbocarautohomeprop.setP145(rs.getString("p145"));//�����
		dbocarautohomeprop.setP146(rs.getString("p146"));//�ռ��г���
		dbocarautohomeprop.setP147(rs.getString("p147"));//�Զ�ͷ��
		dbocarautohomeprop.setP148(rs.getString("p148"));//ת��ͷ��(�����)
		dbocarautohomeprop.setP149(rs.getString("p149"));//ǰ���
		dbocarautohomeprop.setP150(rs.getString("p150"));//�����
		dbocarautohomeprop.setP151(rs.getString("p151"));//��Ƹ߶ȿɵ�
		dbocarautohomeprop.setP152(rs.getString("p152"));//�����ϴװ��
		dbocarautohomeprop.setP153(rs.getString("p153"));//ǰ�綯����
		dbocarautohomeprop.setP154(rs.getString("p154"));//��綯����
		dbocarautohomeprop.setP155(rs.getString("p155"));//���������ֹ���
		dbocarautohomeprop.setP156(rs.getString("p156"));//���Ӿ��綯����
		dbocarautohomeprop.setP157(rs.getString("p157"));//���Ӿ�����
		dbocarautohomeprop.setP158(rs.getString("p158"));//��/����Ӿ��Զ���ѣĿ
		dbocarautohomeprop.setP159(rs.getString("p159"));//���Ӿ��綯�۵�
		dbocarautohomeprop.setP160(rs.getString("p160"));//��絲������
		dbocarautohomeprop.setP161(rs.getString("p161"));//���Ų�������
		dbocarautohomeprop.setP162(rs.getString("p162"));//�����廯ױ��
		dbocarautohomeprop.setP163(rs.getString("p163"));//��Ӧ��ˢ
		dbocarautohomeprop.setP164(rs.getString("p164"));//�ֶ��յ�
		dbocarautohomeprop.setP165(rs.getString("p165"));//�Զ��յ�
		dbocarautohomeprop.setP166(rs.getString("p166"));//���Ŷ����յ�
		dbocarautohomeprop.setP167(rs.getString("p167"));//��������
		dbocarautohomeprop.setP168(rs.getString("p168"));//�¶ȷ������
		dbocarautohomeprop.setP169(rs.getString("p169"));//�������/���۹���
		dbocarautohomeprop.setP170(rs.getString("p170"));//���ر���
		dbocarautohomeprop.setP171(rs.getString("p171"));//�Զ�������λ
		dbocarautohomeprop.setP172(rs.getString("p172"));//���߸���
		dbocarautohomeprop.setP173(rs.getString("p173"));//ҹ��ϵͳ
		dbocarautohomeprop.setP174(rs.getString("p174"));//����ӦѲ��
		dbocarautohomeprop.setP175(rs.getString("p175"));//ȫ������ͷ
		dbocarautohomeprop.setP176(rs.getString("p176"));//����������
		dbocarautohomeprop.setP177(rs.getString("p177"));//������
		dbocarautohomeprop.setP178(rs.getString("p178"));//�������
		dbocarautohomeprop.setP179(rs.getString("p179"));//��������
		dbocarautohomeprop.setP180(rs.getString("p180"));//�綯�����
		dbocarautohomeprop.setP181(rs.getString("p181"));//�����̵綯����
		dbocarautohomeprop.setP182(rs.getString("p182"));//�粿֧�ŵ���
		dbocarautohomeprop.setP183(rs.getString("p183"));//��λ��������
		dbocarautohomeprop.setP184(rs.getString("p184"));//����/���ص绰
		dbocarautohomeprop.setP185(rs.getString("p185"));//������cd
		dbocarautohomeprop.setP186(rs.getString("p186"));//���ڷ�Χ��
		dbocarautohomeprop.setP187(rs.getString("p187"));//��������/���Ȳ���
		dbocarautohomeprop.setP188(rs.getString("p188"));//����ˢ
		dbocarautohomeprop.setP189(rs.getString("p189"));//����ɲ��/������ȫϵͳ
		dbocarautohomeprop.setP190(rs.getString("p190"));//��������ת��ϵͳ
		dbocarautohomeprop.setP191(rs.getString("p191"));//�п�Һ����������ʾ
		dbocarautohomeprop.setP192(rs.getString("p192"));//����
		dbocarautohomeprop.setP193(rs.getString("p193"));//���Ų��ۺ��ͺ�(l)
		dbocarautohomeprop.setP194(rs.getString("p194"));//�������ͺ�
		dbocarautohomeprop.setP195(rs.getString("p195"));//�ڶ��ſ����Ƕȵ���
		dbocarautohomeprop.setP196(rs.getString("p196"));//�ڶ��������ƶ�
		dbocarautohomeprop.setP197(rs.getString("p197"));//���Ӿ�����
		dbocarautohomeprop.setP198(rs.getString("p198"));//iso fix��ͯ���νӿ�
		dbocarautohomeprop.setP199(rs.getString("p199"));//latch��ͯ���νӿ�
		dbocarautohomeprop.setP200(rs.getString("p200"));//������ɫ
		...
		dbocarautohomeprop.setIway(rs.getString("iway"));//����
		dbocarautohomeprop.setCar_type(rs.getInt("car_type"));//���ͷ��� 1��ͨ���ͣ�2����͵ȣ�3�͵�춯���ͣ�4���綯����
	}
	...
	public static int save(DBConnect194 dbc,DboCarAutohomeprop dbocarautohomeprop) throws Exception {
		int result = EXECUTE_FAIL;
		String sql = "insert into dbo_car_autohomeprop(`carid`,`autohomecarid`,`bid`,`p1`,`p2`,`p3`,`p4`,`p5`,`p6`,`p7`,`p8`,`p9`,`p10`,`p11`,`p12`,`p13`,`p14`,`p15`,`p16`,`p17`,`p18`,`p19`,`p20`,`p21`,`p22`,`p23`,`p24`,`p25`,`p26`,`p27`,`p28`,`p29`,`p30`,`p31`,`p32`,`p33`,`p34`,`p35`,`p36`,`p37`,`p38`,`p39`,`p40`,`p41`,`p42`,`p43`,`p44`,`p45`,`p46`,`p47`,`p48`,`p49`,`p50`,`p51`,`p52`,`p53`,`p54`,`p55`,`p56`,`p57`,`p58`,`p59`,`p60`,`p61`,`p62`,`p63`,`p64`,`p65`,`p66`,`p67`,`p68`,`p69`,`p70`,`p71`,`p72`,`p73`,`p74`,`p75`,`p76`,`p77`,`p78`,`p79`,`p80`,`p81`,`p82`,`p83`,`p84`,`p85`,`p86`,`p87`,`p88`,`p89`,`p90`,`p91`,`p92`,`p93`,`p94`,`p95`,`p96`,`p97`,`p98`,`p99`,`p100`,`p101`,`p102`,`p103`,`p104`,`p105`,`p106`,`p107`,`p108`,`p109`,`p110`,`p111`,`p112`,`p113`,`p114`,`p115`,`p116`,`p117`,`p118`,`p119`,`p120`,`p121`,`p122`,`p123`,`p124`,`p125`,`p126`,`p127`,`p128`,`p129`,`p130`,`p131`,`p132`,`p133`,`p134`,`p135`,`p136`,`p137`,`p138`,`p139`,`p140`,`p141`,`p142`,`p143`,`p144`,`p145`,`p146`,`p147`,`p148`,`p149`,`p150`,`p151`,`p152`,`p153`,`p154`,`p155`,`p156`,`p157`,`p158`,`p159`,`p160`,`p161`,`p162`,`p163`,`p164`,`p165`,`p166`,`p167`,`p168`,`p169`,`p170`,`p171`,`p172`,`p173`,`p174`,`p175`,`p176`,`p177`,`p178`,`p179`,`p180`,`p181`,`p182`,`p183`,`p184`,`p185`,`p186`,`p187`,`p188`,`p189`,`p190`,`p191`,`p192`,`p193`,`p194`,`p195`,`p196`,`p197`,`p198`,`p199`,`p200`,`p201`,`p202`,`p203`,`p204`,`p205`,`p206`,`p207`,`p208`,`p209`,`p210`,`p211`,`p212`,`p213`,`p214`,`p215`,`p216`,`p217`,`p218`,`p219`,`p220`,`p221`,`p222`,`p223`,`p224`,`p225`,`p226`,`p227`,`p228`,`p229`,`p230`,`p231`,`p232`,`p233`,`p234`,`p235`,`p236`,`p237`,`p238`,`p239`,`p240`,`p241`,`p242`,`p243`,`p244`,`p245`,`p246`,`p247`,`p248`,`p249`,`p250`,`p251`,`p252`,`p253`,`p254`,`p255`,`p256`,`p257`,`p258`,`p259`,`p260`,`p261`,`p262`,`p263`,`p264`,`p265`,`p266`,`p267`,`p268`,`p269`,`p270`,`p271`,`p272`,`p273`,`p274`,`p275`,`p276`,`p277`,`p278`,`p279`,`p280`,`p281`,`p282`,`p283`,`p284`,`p285`,`p286`,`p287`,`p288`,`p289`,`p290`,`p291`,`p292`,`p293`,`p294`,`p295`,`p296`,`p297`,`p298`,`p299`,`p300`,`isupdate`,`iway`,`car_type`) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		dbc.prepareStatement(sql);
		dbc.setInt(2-1, dbocarautohomeprop.getCarid());
		dbc.setInt(3-1, dbocarautohomeprop.getAutohomecarid());
		dbc.setInt(4-1, dbocarautohomeprop.getBid());
		dbc.setString(5-1, dbocarautohomeprop.getP1());
		dbc.setString(6-1, dbocarautohomeprop.getP2());
		dbc.setString(7-1, dbocarautohomeprop.getP3());
		dbc.setString(8-1, dbocarautohomeprop.getP4());
		dbc.setString(9-1, dbocarautohomeprop.getP5());
		dbc.setString(10-1, dbocarautohomeprop.getP6());
		dbc.setString(11-1, dbocarautohomeprop.getP7());
		dbc.setString(12-1, dbocarautohomeprop.getP8());
		dbc.setString(13-1, dbocarautohomeprop.getP9());
		dbc.setString(14-1, dbocarautohomeprop.getP10());
		dbc.setString(15-1, dbocarautohomeprop.getP11());
		dbc.setString(16-1, dbocarautohomeprop.getP12());
		dbc.setString(17-1, dbocarautohomeprop.getP13());
		dbc.setString(18-1, dbocarautohomeprop.getP14());
		dbc.setString(19-1, dbocarautohomeprop.getP15());
		dbc.setString(20-1, dbocarautohomeprop.getP16());
		dbc.setString(21-1, dbocarautohomeprop.getP17());
		dbc.setString(22-1, dbocarautohomeprop.getP18());
		dbc.setString(23-1, dbocarautohomeprop.getP19());
		dbc.setString(24-1, dbocarautohomeprop.getP20());
		dbc.setString(25-1, dbocarautohomeprop.getP21());
		dbc.setString(26-1, dbocarautohomeprop.getP22());
		dbc.setString(27-1, dbocarautohomeprop.getP23());
		dbc.setString(28-1, dbocarautohomeprop.getP24());
		dbc.setString(29-1, dbocarautohomeprop.getP25());
		dbc.setString(30-1, dbocarautohomeprop.getP26());
		dbc.setString(31-1, dbocarautohomeprop.getP27());
		dbc.setString(32-1, dbocarautohomeprop.getP28());
		dbc.setString(33-1, dbocarautohomeprop.getP29());
		dbc.setString(34-1, dbocarautohomeprop.getP30());
		dbc.setString(35-1, dbocarautohomeprop.getP31());
		dbc.setString(36-1, dbocarautohomeprop.getP32());
		dbc.setString(37-1, dbocarautohomeprop.getP33());
		dbc.setString(38-1, dbocarautohomeprop.getP34());
		dbc.setString(39-1, dbocarautohomeprop.getP35());
		dbc.setString(40-1, dbocarautohomeprop.getP36());
		dbc.setString(41-1, dbocarautohomeprop.getP37());
		dbc.setString(42-1, dbocarautohomeprop.getP38());
		dbc.setString(43-1, dbocarautohomeprop.getP39());
		dbc.setString(44-1, dbocarautohomeprop.getP40());
		dbc.setString(45-1, dbocarautohomeprop.getP41());
		dbc.setString(46-1, dbocarautohomeprop.getP42());
		dbc.setString(47-1, dbocarautohomeprop.getP43());
		dbc.setString(48-1, dbocarautohomeprop.getP44());
		dbc.setString(49-1, dbocarautohomeprop.getP45());
		dbc.setString(50-1, dbocarautohomeprop.getP46());
		dbc.setString(51-1, dbocarautohomeprop.getP47());
		dbc.setString(52-1, dbocarautohomeprop.getP48());
		dbc.setString(53-1, dbocarautohomeprop.getP49());
		dbc.setString(54-1, dbocarautohomeprop.getP50());
		dbc.setString(55-1, dbocarautohomeprop.getP51());
		dbc.setString(56-1, dbocarautohomeprop.getP52());
		dbc.setString(57-1, dbocarautohomeprop.getP53());
		dbc.setString(58-1, dbocarautohomeprop.getP54());
		dbc.setString(59-1, dbocarautohomeprop.getP55());
		dbc.setString(60-1, dbocarautohomeprop.getP56());
		dbc.setString(61-1, dbocarautohomeprop.getP57());
		dbc.setString(62-1, dbocarautohomeprop.getP58());
		dbc.setString(63-1, dbocarautohomeprop.getP59());
		dbc.setString(64-1, dbocarautohomeprop.getP60());
		dbc.setString(65-1, dbocarautohomeprop.getP61());
		dbc.setString(66-1, dbocarautohomeprop.getP62());
		dbc.setString(67-1, dbocarautohomeprop.getP63());
		dbc.setString(68-1, dbocarautohomeprop.getP64());
		dbc.setString(69-1, dbocarautohomeprop.getP65());
		dbc.setString(70-1, dbocarautohomeprop.getP66());
		dbc.setString(71-1, dbocarautohomeprop.getP67());
		dbc.setString(72-1, dbocarautohomeprop.getP68());
		dbc.setString(73-1, dbocarautohomeprop.getP69());
		dbc.setString(74-1, dbocarautohomeprop.getP70());
		dbc.setString(75-1, dbocarautohomeprop.getP71());
		dbc.setString(76-1, dbocarautohomeprop.getP72());
		dbc.setString(77-1, dbocarautohomeprop.getP73());
		dbc.setString(78-1, dbocarautohomeprop.getP74());
		dbc.setString(79-1, dbocarautohomeprop.getP75());
		dbc.setString(80-1, dbocarautohomeprop.getP76());
		dbc.setString(81-1, dbocarautohomeprop.getP77());
		dbc.setString(82-1, dbocarautohomeprop.getP78());
		dbc.setString(83-1, dbocarautohomeprop.getP79());
		dbc.setString(84-1, dbocarautohomeprop.getP80());
		dbc.setString(85-1, dbocarautohomeprop.getP81());
		dbc.setString(86-1, dbocarautohomeprop.getP82());
		dbc.setString(87-1, dbocarautohomeprop.getP83());
		dbc.setString(88-1, dbocarautohomeprop.getP84());
		dbc.setString(89-1, dbocarautohomeprop.getP85());
		dbc.setString(90-1, dbocarautohomeprop.getP86());
		dbc.setString(91-1, dbocarautohomeprop.getP87());
		dbc.setString(92-1, dbocarautohomeprop.getP88());
		dbc.setString(93-1, dbocarautohomeprop.getP89());
		dbc.setString(94-1, dbocarautohomeprop.getP90());
		dbc.setString(95-1, dbocarautohomeprop.getP91());
		dbc.setString(96-1, dbocarautohomeprop.getP92());
		dbc.setString(97-1, dbocarautohomeprop.getP93());
		dbc.setString(98-1, dbocarautohomeprop.getP94());
		dbc.setString(99-1, dbocarautohomeprop.getP95());
		dbc.setString(100-1, dbocarautohomeprop.getP96());
		dbc.setString(101-1, dbocarautohomeprop.getP97());
		dbc.setString(102-1, dbocarautohomeprop.getP98());
		dbc.setString(103-1, dbocarautohomeprop.getP99());
		dbc.setString(104-1, dbocarautohomeprop.getP100());
		dbc.setString(105-1, dbocarautohomeprop.getP101());
		dbc.setString(106-1, dbocarautohomeprop.getP102());
		dbc.setString(107-1, dbocarautohomeprop.getP103());
		dbc.setString(108-1, dbocarautohomeprop.getP104());
		dbc.setString(109-1, dbocarautohomeprop.getP105());
		dbc.setString(110-1, dbocarautohomeprop.getP106());
		dbc.setString(111-1, dbocarautohomeprop.getP107());
		dbc.setString(112-1, dbocarautohomeprop.getP108());
		dbc.setString(113-1, dbocarautohomeprop.getP109());
		dbc.setString(114-1, dbocarautohomeprop.getP110());
		dbc.setString(115-1, dbocarautohomeprop.getP111());
		dbc.setString(116-1, dbocarautohomeprop.getP112());
		dbc.setString(117-1, dbocarautohomeprop.getP113());
		dbc.setString(118-1, dbocarautohomeprop.getP114());
		dbc.setString(119-1, dbocarautohomeprop.getP115());
		dbc.setString(120-1, dbocarautohomeprop.getP116());
		dbc.setString(121-1, dbocarautohomeprop.getP117());
		dbc.setString(122-1, dbocarautohomeprop.getP118());
		dbc.setString(123-1, dbocarautohomeprop.getP119());
		dbc.setString(124-1, dbocarautohomeprop.getP120());
		dbc.setString(125-1, dbocarautohomeprop.getP121());
		dbc.setString(126-1, dbocarautohomeprop.getP122());
		dbc.setString(127-1, dbocarautohomeprop.getP123());
		dbc.setString(128-1, dbocarautohomeprop.getP124());
		dbc.setString(129-1, dbocarautohomeprop.getP125());
		dbc.setString(130-1, dbocarautohomeprop.getP126());
		dbc.setString(131-1, dbocarautohomeprop.getP127());
		dbc.setString(132-1, dbocarautohomeprop.getP128());
		dbc.setString(133-1, dbocarautohomeprop.getP129());
		dbc.setString(134-1, dbocarautohomeprop.getP130());
		dbc.setString(135-1, dbocarautohomeprop.getP131());
		dbc.setString(136-1, dbocarautohomeprop.getP132());
		dbc.setString(137-1, dbocarautohomeprop.getP133());
		dbc.setString(138-1, dbocarautohomeprop.getP134());
		dbc.setString(139-1, dbocarautohomeprop.getP135());
		dbc.setString(140-1, dbocarautohomeprop.getP136());
		dbc.setString(141-1, dbocarautohomeprop.getP137());
		dbc.setString(142-1, dbocarautohomeprop.getP138());
		dbc.setString(143-1, dbocarautohomeprop.getP139());
		dbc.setString(144-1, dbocarautohomeprop.getP140());
		dbc.setString(145-1, dbocarautohomeprop.getP141());
		dbc.setString(146-1, dbocarautohomeprop.getP142());
		dbc.setString(147-1, dbocarautohomeprop.getP143());
		dbc.setString(148-1, dbocarautohomeprop.getP144());
		dbc.setString(149-1, dbocarautohomeprop.getP145());
		dbc.setString(150-1, dbocarautohomeprop.getP146());
		dbc.setString(151-1, dbocarautohomeprop.getP147());
		dbc.setString(152-1, dbocarautohomeprop.getP148());
		dbc.setString(153-1, dbocarautohomeprop.getP149());
		dbc.setString(154-1, dbocarautohomeprop.getP150());
		dbc.setString(155-1, dbocarautohomeprop.getP151());
		dbc.setString(156-1, dbocarautohomeprop.getP152());
		dbc.setString(157-1, dbocarautohomeprop.getP153());
		dbc.setString(158-1, dbocarautohomeprop.getP154());
		dbc.setString(159-1, dbocarautohomeprop.getP155());
		dbc.setString(160-1, dbocarautohomeprop.getP156());
		dbc.setString(161-1, dbocarautohomeprop.getP157());
		dbc.setString(162-1, dbocarautohomeprop.getP158());
		dbc.setString(163-1, dbocarautohomeprop.getP159());
		dbc.setString(164-1, dbocarautohomeprop.getP160());
		dbc.setString(165-1, dbocarautohomeprop.getP161());
		dbc.setString(166-1, dbocarautohomeprop.getP162());
		dbc.setString(167-1, dbocarautohomeprop.getP163());
		dbc.setString(168-1, dbocarautohomeprop.getP164());
		dbc.setString(169-1, dbocarautohomeprop.getP165());
		dbc.setString(170-1, dbocarautohomeprop.getP166());
		dbc.setString(171-1, dbocarautohomeprop.getP167());
		dbc.setString(172-1, dbocarautohomeprop.getP168());
		dbc.setString(173-1, dbocarautohomeprop.getP169());
		dbc.setString(174-1, dbocarautohomeprop.getP170());
		dbc.setString(175-1, dbocarautohomeprop.getP171());
		dbc.setString(176-1, dbocarautohomeprop.getP172());
		dbc.setString(177-1, dbocarautohomeprop.getP173());
		dbc.setString(178-1, dbocarautohomeprop.getP174());
		dbc.setString(179-1, dbocarautohomeprop.getP175());
		dbc.setString(180-1, dbocarautohomeprop.getP176());
		dbc.setString(181-1, dbocarautohomeprop.getP177());
		dbc.setString(182-1, dbocarautohomeprop.getP178());
		dbc.setString(183-1, dbocarautohomeprop.getP179());
		dbc.setString(184-1, dbocarautohomeprop.getP180());
		dbc.setString(185-1, dbocarautohomeprop.getP181());
		dbc.setString(186-1, dbocarautohomeprop.getP182());
		dbc.setString(187-1, dbocarautohomeprop.getP183());
		dbc.setString(188-1, dbocarautohomeprop.getP184());
		dbc.setString(189-1, dbocarautohomeprop.getP185());
		dbc.setString(190-1, dbocarautohomeprop.getP186());
		dbc.setString(191-1, dbocarautohomeprop.getP187());
		dbc.setString(192-1, dbocarautohomeprop.getP188());
		dbc.setString(193-1, dbocarautohomeprop.getP189());
		dbc.setString(194-1, dbocarautohomeprop.getP190());
		dbc.setString(195-1, dbocarautohomeprop.getP191());
		dbc.setString(196-1, dbocarautohomeprop.getP192());
		dbc.setString(197-1, dbocarautohomeprop.getP193());
		dbc.setString(198-1, dbocarautohomeprop.getP194());
		dbc.setString(199-1, dbocarautohomeprop.getP195());
		dbc.setString(200-1, dbocarautohomeprop.getP196());
		dbc.setString(201-1, dbocarautohomeprop.getP197());
		dbc.setString(202-1, dbocarautohomeprop.getP198());
		dbc.setString(203-1, dbocarautohomeprop.getP199());
		dbc.setString(204-1, dbocarautohomeprop.getP200());
		dbc.setString(205-1, dbocarautohomeprop.getP201());
		dbc.setString(206-1, dbocarautohomeprop.getP202());
		dbc.setString(207-1, dbocarautohomeprop.getP203());
		dbc.setString(208-1, dbocarautohomeprop.getP204());
		dbc.setString(209-1, dbocarautohomeprop.getP205());
		dbc.setString(210-1, dbocarautohomeprop.getP206());
		dbc.setString(211-1, dbocarautohomeprop.getP207());
		dbc.setString(212-1, dbocarautohomeprop.getP208());
		dbc.setString(213-1, dbocarautohomeprop.getP209());
		dbc.setString(214-1, dbocarautohomeprop.getP210());
		dbc.setString(215-1, dbocarautohomeprop.getP211());
		dbc.setString(216-1, dbocarautohomeprop.getP212());
		dbc.setString(217-1, dbocarautohomeprop.getP213());
		dbc.setString(218-1, dbocarautohomeprop.getP214());
		dbc.setString(219-1, dbocarautohomeprop.getP215());
		dbc.setString(220-1, dbocarautohomeprop.getP216());
		dbc.setString(221-1, dbocarautohomeprop.getP217());
		dbc.setString(222-1, dbocarautohomeprop.getP218());
		dbc.setString(223-1, dbocarautohomeprop.getP219());
		dbc.setString(224-1, dbocarautohomeprop.getP220());
		dbc.setString(225-1, dbocarautohomeprop.getP221());
		dbc.setString(226-1, dbocarautohomeprop.getP222());
		dbc.setString(227-1, dbocarautohomeprop.getP223());
		dbc.setString(228-1, dbocarautohomeprop.getP224());
		dbc.setString(229-1, dbocarautohomeprop.getP225());
		dbc.setString(230-1, dbocarautohomeprop.getP226());
		dbc.setString(231-1, dbocarautohomeprop.getP227());
		dbc.setString(232-1, dbocarautohomeprop.getP228());
		dbc.setString(233-1, dbocarautohomeprop.getP229());
		dbc.setString(234-1, dbocarautohomeprop.getP230());
		dbc.setString(235-1, dbocarautohomeprop.getP231());
		dbc.setString(236-1, dbocarautohomeprop.getP232());
		dbc.setString(237-1, dbocarautohomeprop.getP233());
		dbc.setString(238-1, dbocarautohomeprop.getP234());
		dbc.setString(239-1, dbocarautohomeprop.getP235());
		dbc.setString(240-1, dbocarautohomeprop.getP236());
		dbc.setString(241-1, dbocarautohomeprop.getP237());
		dbc.setString(242-1, dbocarautohomeprop.getP238());
		dbc.setString(243-1, dbocarautohomeprop.getP239());
		dbc.setString(244-1, dbocarautohomeprop.getP240());
		dbc.setString(245-1, dbocarautohomeprop.getP241());
		dbc.setString(246-1, dbocarautohomeprop.getP242());
		dbc.setString(247-1, dbocarautohomeprop.getP243());
		dbc.setString(248-1, dbocarautohomeprop.getP244());
		dbc.setString(249-1, dbocarautohomeprop.getP245());
		dbc.setString(250-1, dbocarautohomeprop.getP246());
		dbc.setString(251-1, dbocarautohomeprop.getP247());
		dbc.setString(252-1, dbocarautohomeprop.getP248());
		dbc.setString(253-1, dbocarautohomeprop.getP249());
		dbc.setString(254-1, dbocarautohomeprop.getP250());
		dbc.setString(255-1, dbocarautohomeprop.getP251());
		dbc.setString(256-1, dbocarautohomeprop.getP252());
		dbc.setString(257-1, dbocarautohomeprop.getP253());
		dbc.setString(258-1, dbocarautohomeprop.getP254());
		dbc.setString(259-1, dbocarautohomeprop.getP255());
		dbc.setString(260-1, dbocarautohomeprop.getP256());
		dbc.setString(261-1, dbocarautohomeprop.getP257());
		dbc.setString(262-1, dbocarautohomeprop.getP258());
		dbc.setString(263-1, dbocarautohomeprop.getP259());
		dbc.setString(264-1, dbocarautohomeprop.getP260());
		dbc.setString(265-1, dbocarautohomeprop.getP261());
		dbc.setString(266-1, dbocarautohomeprop.getP262());
		dbc.setString(267-1, dbocarautohomeprop.getP263());
		dbc.setString(268-1, dbocarautohomeprop.getP264());
		dbc.setString(269-1, dbocarautohomeprop.getP265());
		dbc.setString(270-1, dbocarautohomeprop.getP266());
		dbc.setString(271-1, dbocarautohomeprop.getP267());
		dbc.setString(272-1, dbocarautohomeprop.getP268());
		dbc.setString(273-1, dbocarautohomeprop.getP269());
		dbc.setString(274-1, dbocarautohomeprop.getP270());
		dbc.setString(275-1, dbocarautohomeprop.getP271());
		dbc.setString(276-1, dbocarautohomeprop.getP272());
		dbc.setString(277-1, dbocarautohomeprop.getP273());
		dbc.setString(278-1, dbocarautohomeprop.getP274());
		dbc.setString(279-1, dbocarautohomeprop.getP275());
		dbc.setString(280-1, dbocarautohomeprop.getP276());
		dbc.setString(281-1, dbocarautohomeprop.getP277());
		dbc.setString(282-1, dbocarautohomeprop.getP278());
		dbc.setString(283-1, dbocarautohomeprop.getP279());
		dbc.setString(284-1, dbocarautohomeprop.getP280());
		dbc.setString(285-1, dbocarautohomeprop.getP281());
		dbc.setString(286-1, dbocarautohomeprop.getP282());
		dbc.setString(287-1, dbocarautohomeprop.getP283());
		dbc.setString(288-1, dbocarautohomeprop.getP284());
		dbc.setString(289-1, dbocarautohomeprop.getP285());
		dbc.setString(290-1, dbocarautohomeprop.getP286());
		dbc.setString(291-1, dbocarautohomeprop.getP287());
		dbc.setString(292-1, dbocarautohomeprop.getP288());
		dbc.setString(293-1, dbocarautohomeprop.getP289());
		dbc.setString(294-1, dbocarautohomeprop.getP290());
		dbc.setString(295-1, dbocarautohomeprop.getP291());
		dbc.setString(296-1, dbocarautohomeprop.getP292());
		dbc.setString(297-1, dbocarautohomeprop.getP293());
		dbc.setString(298-1, dbocarautohomeprop.getP294());
		dbc.setString(299-1, dbocarautohomeprop.getP295());
		dbc.setString(300-1, dbocarautohomeprop.getP296());
		dbc.setString(301-1, dbocarautohomeprop.getP297());
		dbc.setString(302-1, dbocarautohomeprop.getP298());
		dbc.setString(303-1, dbocarautohomeprop.getP299());
		dbc.setString(304-1, dbocarautohomeprop.getP300());
		dbc.setInt(305-1, dbocarautohomeprop.getIsupdate());
		dbc.setString(306-1, dbocarautohomeprop.getIway());
		dbc.setInt(307-1, dbocarautohomeprop.getCar_type());
		dbc.executeUpdate();
		result = EXECUTE_SUCCESSS;
		return result;
	}
