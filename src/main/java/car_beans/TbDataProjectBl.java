...
public class  TbDataProjectBl  implements java.io.Serializable{
	...
	private int service_type;//业务类型(0-看车团，1-直销，2-车展，3-大客户,4-经销商)
	...
	private int pro_state;//项目状态(0-未审核、1-业务通过、2-业务驳回、3-推广部通过、4-推广部驳回,5-已结束)
