...
public class DBConnect2 {
	...
	private DBConnectionManagerFin dcm;

	private Connection conn = null;

	private PreparedStatement prepstmt = null;

	private int isTX = 0;// �Ƿ�������;0|��1|����

	void init() {
		dcm = DBConnectionManagerFin.getInstance();
		conn = dcm.getConnection();
	}

	public DBConnect2() throws Exception {

		init();
	}

	public DBConnect2(int is_tx) throws Exception {
		isTX = is_tx;
		init();
	}
	 ...
	 *            SQL���
	 */
	public DBConnect2(String sql) throws Exception {
		init();
