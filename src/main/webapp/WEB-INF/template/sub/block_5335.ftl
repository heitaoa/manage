var str='';
str+='			<ul class="article-list" id="ui_wqhg">	';
...
str+='						<p class="desc"><#if sub_data.content??>${sub_data.content}<#else>优秀的你就需要如此高端的车与之相配。</#if><a class="more" target="_blank" href="${sub_data.link}">【详细】</a></p>	';
<#else>
str+='						<p class="desc"><#if sub_data.content??>${sub_data.content[0..99]}...<#else>优秀的你就需要如此高端的车与之相配。</#if><a class="more" target="_blank" href="${sub_data.link}">【详细】</a></p>	';
</#if>
...
str+='			</ul>	';
str+='		<div class="article-more"><a  onclick="getWqhgAdd(5335)">查看更多新闻 &rsaquo;&rsaquo;</a></div>	';
document.write(str);
