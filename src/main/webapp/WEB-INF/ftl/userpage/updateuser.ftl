			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						...
						<div style="width:100px; float:left;"><input type="checkbox"  class="checkboxes" value="0" name="level" <#if user.ulevel?index_of("0")!=-1>checked="checked"</#if> >系统管理员</div>
						<div style="width:100px; float:left;"><input type="checkbox"  class="checkboxes" value="1" name="level" <#if user.ulevel?index_of("1")!=-1>checked="checked"</#if>>大客户销售</div>
						...
						<div style="width:100px; float:left;"><input type="checkbox"  class="checkboxes" value="6" name="level" <#if user.ulevel?index_of("6")!=-1>checked="checked"</#if>>分站管理员</div>
						<div style="width:100px; float:left;"><input type="checkbox"  class="checkboxes" value="4" name="level" <#if user.ulevel?index_of("4")!=-1>checked="checked"</#if>>总站编辑</div>
