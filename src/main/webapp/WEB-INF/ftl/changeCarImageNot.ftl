		...
		<div class="portlet box grey-cascade">
			...
			<div class="portlet-body">
                ...
                <tr>
                  ...
                  <th width="32%" align="center">图片</th>
              ...
              <#list imgPageList as il>
                <tr>
                  ...
                  <td>${il.title}</td>
                  <td align="center"><img width="320" src="<@cc.img_url pic=il.path/>" alt=""></td>
				...
				<div class="table-toolbar">
					<div class="row">
						<div class="col-md-4">
							<div style="margin: 10px 0;">
								<a class="btn green" href="./carImageEditNot?editTitleId=${titleId}">添加新页</a>
                    			<a class="btn green" href="./carImageManageNot?carTypeArr=${carTypeArr}&page=${beforepage}">返回图片主题列表</a>
							</div>
						</div>
						<div class="col-md-8">
							<div class="pull-right">
								<@cc.pager1 url="changeCarImageNot?titleId=${titleId}&" currentPage=page totalPage=totalPage rows=rows/>
							</div>
						</div>
					</div>
				</div>
...
if(!confirm("确认要删除吗？")){
	...
	window.location.href="deleteImageContentNot?deleteid="+deleteid;
}
function deleteImageContentBatch(){
	...
	document.forms[0].action = "deleteImageContentBatchNot";
...
function changeSort(csort,nid,nsort,cid){
	...
	$("#nowsort").val(nsort);
	$("#changeid").val(cid);
	document.forms[0].action = "changeSortNot";
	document.forms[0].submit();
}

function carImageEdit(pid,tid){
	window.location.href = "carImageEditNot?editTitleId="+tid+"&imageId="+pid;
}
$(function(){
