	...
	<h3 class="page-title">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="javascript:void(0);">修改模块</a>
					</li>
				</ul>
			</div>
			<!-- EDN PAGE HEADER-->
		...
		<div class="col-md-12">
			...
			<div class="portlet box blue-madison">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-gift"></i>修改模块
					</div>
				</div>
				<div class="portlet-body form">
					<form class="form-horizontal" role="form" action="updateSubjectContent" method="post" id="mouldForm">
						<input type="hidden" value="${content.id!}" name="content.id">
						<div class="form-body">
							<div class="form-group">
								<label class="col-md-3 control-label">模块名称：</label>
								<div class="col-md-3">
									<input type="text" name="content.place" id="place" value="${content.place!}" class="form-control">
								</div>
							</div>
							<input type="hidden" value="${content.pname!}" name="content.pname">
						</div>
