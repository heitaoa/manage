	 ...
	 <div class="col-md-12">
    	...
    	<div>
            <ul class="nav nav-tabs">
            	<li class="active">
                    <a href="#tab_1_1" data-toggle="tab">正常项目</a>
                </li>
                <li>
                    <a href="#tab_1_2" data-toggle="tab">项目补量</a>
                </li>
            </ul>
                                			...
                                			<tr>
                                    			...
                                    			<td>
                                    				...
                                    				<#if p.get("pro_state")=="0">
                                    					<td>未审核</td>
                                    					<td>
                                    						<a href="javascript:viewBl('${p.get("pro_num")}');">查看</a>
                                    						<a href="javascript:deleteProjectBl('${p.get("pro_num")}');">删除</a>
                                    						<a href="javascript:editProjectBl('${p.get("pro_num")}');">编辑</a>
                                    					</td>
...
<div id="edit" class="modal fade" tabindex="-1" data-backdrop="static" data-width="1500">
    		...
    		<form class="form-horizontal" action="ser_editProject"  role="form" id="editProject">
        		<div class="form-body">
                	...
                	<div class="form-group">
                		<label class="col-md-2 control-label">合同开始时间</label>
                   		<div class="col-md-4">
                        	...
                        	<div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" id="edit_contact_start_date_area">
                    	...
                    	<div class="col-md-4">
                        	...
                        	<div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" id="edit_contact_end_date_area">
                	...
                	<div class="form-group">
                    	...
                    	<div class="col-md-4">
                        	<div class="input-group input-medium date date-picker " data-date-format="yyyy-mm-dd" id="edit_acti_start_date_area">
                    	...
                    	<div class="col-md-4">
                        	<div class="input-group input-medium date date-picker " data-date-format="yyyy-mm-dd" id="edit_acti_end_date_area">
...
$(document).ready(function(){
	...
	$("#edit_contact_start_date_area").on('changeDate',function(ev){
		var date = $("#edit_contact_start_date").val();
		var obj = $("#edit_contact_end_date_area");
		setDateLimit("start",date,obj);
	});
	$("#edit_contact_end_date_area").on('changeDate',function(ev){
		var date = $("#edit_contact_end_date").val();
		var obj = $("#edit_contact_start_date_area");
		setDateLimit("end",date,obj);
	});
	$("#edit_promo_start_date_area").on('changeDate',function(ev){
		var date = $("#edit_promo_start_date").val();
		var obj = $("#edit_promo_end_date_area");
		setDateLimit("start",date,obj);
	});
	$("#edit_promo_end_date_area").on('changeDate',function(ev){
		var date = $("#edit_promo_end_date").val();
		var obj = $("#edit_promo_start_date_area");
		setDateLimit("end",date,obj);
	});
	$("#edit_acti_start_date_area").on('changeDate',function(ev){
		var date = $("#edit_acti_start_date").val();
		var obj = $("#edit_acti_end_date_area");
		setDateLimit("start",date,obj);
	});
	$("#edit_acti_end_date_area").on('changeDate',function(ev){
		var date = $("#edit_acti_end_date").val();
		var obj = $("#edit_acti_start_date_area");
		setDateLimit("end",date,obj);
	});
	$("#all").click(function(){
...
    		}
  		});
	}else if(edit_type=="bl"){ 
		$.ajax({
    		type: "POST",
    		url:"ser_editBlProject",
    		data:$('#editProject').serialize(),
    		success: function(data) {
    			if(data==1){
					alert("补量编辑成功！");
...
function deleteProjectBl(pro_num){
	if(confirm('确定删除项目吗?')){
	$.ajax({
    type: "POST",
    url:"ser_deleteBlProject",
    data:{
			"pro_num":pro_num
		},
    success: function(data) {
...
    success: function(data) {
			...
			var obj = $("#edit_contact_end_date_area");
			setDateLimit("start",date,obj);
			date = $("#edit_contact_end_date").val();
			obj = $("#edit_contact_start_date_area");
			setDateLimit("end",date,obj);
			date = $("#edit_promo_start_date").val();
			obj = $("#edit_promo_end_date_area");
			setDateLimit("start",date,obj);
			date = $("#edit_promo_end_date").val();
			obj = $("#edit_promo_start_date_area");
			setDateLimit("end",date,obj);
			date = $("#edit_acti_start_date").val();
			obj = $("#edit_acti_end_date_area");
			setDateLimit("start",date,obj);
			date = $("#edit_acti_end_date").val();
			obj = $("#edit_acti_start_date_area");
			setDateLimit("end",date,obj);
			$("#edit").modal();
    }
  });
}
function editProjectBl(pro_num){
	$("#edit_pinpai").removeAttr("disabled");
	$("#edit_chexi").removeAttr("disabled");
	$("#edit_chexing").removeAttr("disabled");
	$("#edit_type").val("bl");
