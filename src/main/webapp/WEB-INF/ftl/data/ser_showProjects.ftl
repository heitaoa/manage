...
<div class="row" style="margin-left:15px;margin-top:10px;">
	 <div class="col-md-12">
	 	<a  class="btn blue pull-right" style=" float:right; position:relative; top:3px; right:150px;" onclick="addProject();">+发起新推广需求</a>
    	<div class="tabbable tabbable-custom">
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="#tab_1_2" data-toggle="tab">已结束项目 </a>
                </li>
            </ul>
...
    success: function(data) {
    		if(data==1){
				window.location.href="ser_showProjects";
			}else{
				alert("error");
			}
    }
