...
<div class="tools-nav">
	<div class="sort sort3 bar-btn">
		<ul>
			...
			<li class="active"><a href="#">贷款购车</a></li>
...
<div class="tools-con">
	...
	<div class="tools-car-con">
		...
		<div>裸车售价（元）<input id="show_money" type="number" maxlength="2" type="text" class="car-price-input"  value=""  onchange="calcAutoCashAll()"></div>
	</div>
</div>
<div class="tools-con">
	<div class="m-loan-head">
		<ul class="clearfix">
			<li>
				<span>首付款比例：</span>
				<div class="m-select-block" id="s_shoufu">
					<a href="javascript:;" class="current">30%</a> <a href="javascript:;" class="">40%</a> <a href="javascript:;">50%</a> <a href="javascript:;" class="">60%</a> <a href="javascript:;" class="">70%</a>
				</div>
			</li>
			<li>
				<span>贷款期限：</span>
				<div class="m-select-block" id="s_daikuan">
					<a href="javascript:;">1年</a> <a href="javascript:;">2年</a> <a href="javascript:;" class="current">3年</a> <a href="javascript:;">4年</a> <a href="javascript:;">5年</a>
				</div>
			</li>
		</ul>
	</div>
...
<div class="jsq-btns">
	<input type="button" class="btn-one btn-blue" value="计算"  onclick="calcAutoCashAll()"/>
	<p class="tips">计算结果仅供参考，实际费用以当地缴费为准。</p>
</div>
<ul class="m-calculator-list">
	<li class="list-head borderbn">
		<span>贷款首付：<em id="show_shoufu">0元</em> &nbsp; 月供<em id="show_yuefu">0元</em><s id="show_month">(36期)</s> </span>
	</li>
	<li class="list-head borderbn">
		<span id="show_loantotal" class="fwn">总计花费：0万，支付利息：0元</span>
	</li>
	<li><span>贷款额：</span> <b id="show_daikuan">0元</b> </li>
	<li><span>购置税：</span> <b id="show_gouzhitax">0元</b> </li>
	<li><span>上牌费用：</span> <b id="show_chepai">0元</b> </li>
	<li><span>车船使用税：</span> <b id="show_chechuantax">0元</b> <strong><a id="even_chechuantax" href="javascript:void(0);">设置</a></strong></li>
	...
	<li id="popup_jiaoqiang" class="m-popup-item m-popup-arrow m-popup-insurance">
		...
		<div class="m-popup-box">
			<div class="m-popup">
				<label><input type="radio" name="r_jiaoqiang" value="0" checked>家用6座以下</label>
				<label><input type="radio" name="r_jiaoqiang" value="5">家用6座及以上</label>
				<div class="clear">
				</div>
			</div>
		</div>
...
<ul class="m-calculator-sub-list">
	...
	<li id="popup_zeren" class="m-popup-item m-popup-arrow m-popup-insurance">
		...
		<div class="m-popup-box">
			<div class="m-popup">
				<label><input type="radio" name="thirdInsurance" value="0">无</label>
				<label><input type="radio" name="thirdInsurance" value="5">5万</label>
				<label><input type="radio" name="thirdInsurance" value="10" checked>10万</label>
				<label><input type="radio" name="thirdInsurance" value="20">20万</label>
				<label><input type="radio" name="thirdInsurance" value="50">50万</label>
				<label><input type="radio" name="thirdInsurance" value="100">100万</label>
				<div class="clear"></div>
			</div>
		</div>
	</li>
	...
	<li id="popup_boliposui" class="m-popup-item m-popup-arrow m-popup-insurance">
		...
		<div class="m-popup-box">
			<div class="m-popup">
				<label><input type="radio" name="r_boliposui" value="0">无</label>
				<label><input type="radio" name="r_boliposui" value="1">进口</label>
				<label><input type="radio" name="r_boliposui" value="2" checked>国产</label>
				<div class="clear"></div>
			</div>
		</div>
	</li>
	...
	<li id="popup_cheshenhuahen" class="m-popup-item m-popup-arrow m-popup-insurance">
		...
		<div class="m-popup-box">
			<div class="m-popup">
				<label><input type="radio" name="r_cheshenhuahen" value="0">无</label>
				<label><input type="radio" name="r_cheshenhuahen" value="2000">2千</label>
				<label><input type="radio" name="r_cheshenhuahen" value="5000" checked>5千</label>
				<label><input type="radio" name="r_cheshenhuahen" value="10000">1万</label>
				<label><input type="radio" name="r_cheshenhuahen" value="20000">2万</label>
				<div class="clear"></div>
			</div>
		</div>
	</li>
...
function calcAutoCashAll() {
	...
	calcLoanTotal();
	//格式化数字千位符
	$("strong[id^='show_'],b[id^='show_'],em[id^='show_']").html(function(index,html){return formatCurrency(parseInt(html))+"元";})
}
...
$("#even_zeren,#even_cheshenhuahen,#even_chechuantax,#even_jiaoqiang,#even_boliposui").toggle(function () {$(this).parent().parent().next().show(); },
 function () { $(this).parent().parent().next().hide(); });
$("#even_sunshi,#even_daoqiang,#even_ziransunshi,#even_bujimianpei,#even_wuguozeren,#even_reyuanzeren").click(function () {
	
	calcAutoCashAll();
});
$("#s_shoufu a,#s_daikuan a").bind("click",function(){
	$(this).addClass("current").siblings().removeClass("current");
	calcAutoCashAll();
});
</script>